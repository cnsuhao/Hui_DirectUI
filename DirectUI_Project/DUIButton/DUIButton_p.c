...
typedef struct _DUIButton_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } DUIButton_MIDL_TYPE_FORMAT_STRING;

typedef struct _DUIButton_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } DUIButton_MIDL_PROC_FORMAT_STRING;

typedef struct _DUIButton_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } DUIButton_MIDL_EXPR_FORMAT_STRING;
...
extern const DUIButton_MIDL_TYPE_FORMAT_STRING DUIButton__MIDL_TypeFormatString;
extern const DUIButton_MIDL_PROC_FORMAT_STRING DUIButton__MIDL_ProcFormatString;
extern const DUIButton_MIDL_EXPR_FORMAT_STRING DUIButton__MIDL_ExprFormatString;
...
static const DUIButton_MIDL_PROC_FORMAT_STRING DUIButton__MIDL_ProcFormatString =
    {
        0,
        {
...
static const DUIButton_MIDL_TYPE_FORMAT_STRING DUIButton__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_DUIButton_0000_0000, ver. 0.0,
...
static const MIDL_STUBLESS_PROXY_INFO ICommandButton_ProxyInfo =
    {
    &Object_StubDesc,
    DUIButton__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    DUIButton__MIDL_TypeFormatString.Format,
