...
#ifndef __IStrProp_FWD_DEFINED__
#define __IStrProp_FWD_DEFINED__
typedef interface IStrProp IStrProp;
#endif 	/* __IStrProp_FWD_DEFINED__ */


#ifndef __ITextStyleProp_FWD_DEFINED__
#define __ITextStyleProp_FWD_DEFINED__
typedef interface ITextStyleProp ITextStyleProp;
#endif 	/* __ITextStyleProp_FWD_DEFINED__ */
...
#ifndef ___IStrPropEvents_FWD_DEFINED__
#define ___IStrPropEvents_FWD_DEFINED__
typedef interface _IStrPropEvents _IStrPropEvents;
#endif 	/* ___IStrPropEvents_FWD_DEFINED__ */


#ifndef __StrProp_FWD_DEFINED__
#define __StrProp_FWD_DEFINED__

#ifdef __cplusplus
typedef class StrProp StrProp;
#else
typedef struct StrProp StrProp;
#endif /* __cplusplus */

#endif 	/* __StrProp_FWD_DEFINED__ */


#ifndef ___ITextStylePropEvents_FWD_DEFINED__
#define ___ITextStylePropEvents_FWD_DEFINED__
typedef interface _ITextStylePropEvents _ITextStylePropEvents;
#endif 	/* ___ITextStylePropEvents_FWD_DEFINED__ */


#ifndef __TextStyleProp_FWD_DEFINED__
#define __TextStyleProp_FWD_DEFINED__

#ifdef __cplusplus
typedef class TextStyleProp TextStyleProp;
#else
typedef struct TextStyleProp TextStyleProp;
#endif /* __cplusplus */

#endif 	/* __TextStyleProp_FWD_DEFINED__ */
...
/* interface __MIDL_itf_DirectUICom_0000_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_DirectUICom_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_DirectUICom_0000_0000_v0_0_s_ifspec;
...
#ifndef __IStrProp_INTERFACE_DEFINED__
#define __IStrProp_INTERFACE_DEFINED__

/* interface IStrProp */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IStrProp;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("B896488E-CE8F-45BB-83AE-69E15D675F09")
    IStrProp : public IDUIPropBase
    {
    public:
    ...
    interface IStrProp
    {
        CONST_VTBL struct IStrPropVtbl *lpVtbl;
    };
...
#define IStrProp_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IStrProp_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IStrProp_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IStrProp_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IStrProp_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IStrProp_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IStrProp_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IStrProp_SetName(This,strName)	\
    ( (This)->lpVtbl -> SetName(This,strName) ) 

#define IStrProp_GetName(This,pResult)	\
    ( (This)->lpVtbl -> GetName(This,pResult) ) 

#define IStrProp_SetHelp(This,strHelp)	\
    ( (This)->lpVtbl -> SetHelp(This,strHelp) ) 

#define IStrProp_GetHelp(This,pResult)	\
    ( (This)->lpVtbl -> GetHelp(This,pResult) ) 

#define IStrProp_SetType(This,eType)	\
    ( (This)->lpVtbl -> SetType(This,eType) ) 

#define IStrProp_GetType(This,pResult)	\
    ( (This)->lpVtbl -> GetType(This,pResult) ) 

#define IStrProp_SetVariant(This,vt)	\
    ( (This)->lpVtbl -> SetVariant(This,vt) ) 

#define IStrProp_GetVariant(This,pResult)	\
    ( (This)->lpVtbl -> GetVariant(This,pResult) ) 

#define IStrProp_AccessConfig(This,pXmlEle,strKeyName,bRead,bCompleteUseKey,pbResult)	\
    ( (This)->lpVtbl -> AccessConfig(This,pXmlEle,strKeyName,bRead,bCompleteUseKey,pbResult) ) 

#define IStrProp_GetPropTypePtr(This,ppDUIPropType)	\
    ( (This)->lpVtbl -> GetPropTypePtr(This,ppDUIPropType) ) 


#define IStrProp_GetValue(This,strValue)	\
    ( (This)->lpVtbl -> GetValue(This,strValue) ) 

#define IStrProp_SetValue(This,strValue)	\
    ( (This)->lpVtbl -> SetValue(This,strValue) ) 
...
#endif 	/* __IStrProp_INTERFACE_DEFINED__ */


#ifndef __ITextStyleProp_INTERFACE_DEFINED__
#define __ITextStyleProp_INTERFACE_DEFINED__

/* interface ITextStyleProp */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_ITextStyleProp;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("2DA8AAA7-B1E1-4C81-9350-732955F785B1")
    ITextStyleProp : public IDUIPropBase
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RenderDraw( 
            /* [in] */ IDUIRenderDC *pDC,
    ...
    typedef struct ITextStylePropVtbl
    {
        BEGIN_INTERFACE
    ...
    interface ITextStyleProp
    {
        CONST_VTBL struct ITextStylePropVtbl *lpVtbl;
    };
...
#define ITextStyleProp_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ITextStyleProp_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ITextStyleProp_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ITextStyleProp_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define ITextStyleProp_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define ITextStyleProp_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define ITextStyleProp_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define ITextStyleProp_SetName(This,strName)	\
    ( (This)->lpVtbl -> SetName(This,strName) ) 

#define ITextStyleProp_GetName(This,pResult)	\
    ( (This)->lpVtbl -> GetName(This,pResult) ) 

#define ITextStyleProp_SetHelp(This,strHelp)	\
    ( (This)->lpVtbl -> SetHelp(This,strHelp) ) 

#define ITextStyleProp_GetHelp(This,pResult)	\
    ( (This)->lpVtbl -> GetHelp(This,pResult) ) 

#define ITextStyleProp_SetType(This,eType)	\
    ( (This)->lpVtbl -> SetType(This,eType) ) 

#define ITextStyleProp_GetType(This,pResult)	\
    ( (This)->lpVtbl -> GetType(This,pResult) ) 

#define ITextStyleProp_SetVariant(This,vt)	\
    ( (This)->lpVtbl -> SetVariant(This,vt) ) 

#define ITextStyleProp_GetVariant(This,pResult)	\
    ( (This)->lpVtbl -> GetVariant(This,pResult) ) 

#define ITextStyleProp_AccessConfig(This,pXmlEle,strKeyName,bRead,bCompleteUseKey,pbResult)	\
    ( (This)->lpVtbl -> AccessConfig(This,pXmlEle,strKeyName,bRead,bCompleteUseKey,pbResult) ) 

#define ITextStyleProp_GetPropTypePtr(This,ppDUIPropType)	\
    ( (This)->lpVtbl -> GetPropTypePtr(This,ppDUIPropType) ) 


#define ITextStyleProp_RenderDraw(This,pDC,rect,strValue,pbResult)	\
    ( (This)->lpVtbl -> RenderDraw(This,pDC,rect,strValue,pbResult) ) 
...
#endif 	/* __ITextStyleProp_INTERFACE_DEFINED__ */
...
#ifndef ___IStrPropEvents_DISPINTERFACE_DEFINED__
#define ___IStrPropEvents_DISPINTERFACE_DEFINED__

/* dispinterface _IStrPropEvents */
/* [helpstring][uuid] */ 


EXTERN_C const IID DIID__IStrPropEvents;

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("B86A2908-6DDC-4265-B4C0-DD0ABE77882B")
    _IStrPropEvents : public IDispatch
    {
    };
    
#else 	/* C style interface */

    typedef struct _IStrPropEventsVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            _IStrPropEvents * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ 
            __RPC__deref_out  void **ppvObject);
    ...
    interface _IStrPropEvents
    {
        CONST_VTBL struct _IStrPropEventsVtbl *lpVtbl;
    };
...
#define _IStrPropEvents_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define _IStrPropEvents_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define _IStrPropEvents_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define _IStrPropEvents_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define _IStrPropEvents_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define _IStrPropEvents_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define _IStrPropEvents_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* ___IStrPropEvents_DISPINTERFACE_DEFINED__ */


EXTERN_C const CLSID CLSID_StrProp;

#ifdef __cplusplus

class DECLSPEC_UUID("6B95B283-8A69-4B69-9995-ACF413615FB3")
StrProp;
#endif

#ifndef ___ITextStylePropEvents_DISPINTERFACE_DEFINED__
#define ___ITextStylePropEvents_DISPINTERFACE_DEFINED__

/* dispinterface _ITextStylePropEvents */
/* [helpstring][uuid] */ 


EXTERN_C const IID DIID__ITextStylePropEvents;

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("F58FDA42-C699-46B4-A6BF-4A0FD863A15E")
    _ITextStylePropEvents : public IDispatch
    {
    };
    
#else 	/* C style interface */

    typedef struct _ITextStylePropEventsVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            _ITextStylePropEvents * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ 
            __RPC__deref_out  void **ppvObject);
        ...
        END_INTERFACE
    } _ITextStylePropEventsVtbl;

    interface _ITextStylePropEvents
    {
        CONST_VTBL struct _ITextStylePropEventsVtbl *lpVtbl;
    };
...
#define _ITextStylePropEvents_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define _ITextStylePropEvents_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define _ITextStylePropEvents_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define _ITextStylePropEvents_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define _ITextStylePropEvents_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define _ITextStylePropEvents_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define _ITextStylePropEvents_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* ___ITextStylePropEvents_DISPINTERFACE_DEFINED__ */


EXTERN_C const CLSID CLSID_TextStyleProp;

#ifdef __cplusplus

class DECLSPEC_UUID("3453EFAB-DB30-4932-AF56-7B4DAC898B26")
TextStyleProp;
#endif
