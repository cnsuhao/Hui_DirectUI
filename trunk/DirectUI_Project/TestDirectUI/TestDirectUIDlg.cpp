...
void CTestDirectUIDlg::Init()
{
	...
	pButton->SetText(L"无窗口句柄",&bResult);
	SkinRect rect = {20,20,123,95};
	pButton->SetRect(rect);//*/

	DUIImageBase duiimgbase;
	duiimgbase.strImagePath = L"button.bmp";

	duiimgbase.rect.left = 1;
	duiimgbase.rect.top = 1;
	duiimgbase.rect.right = /*19*/104;
	duiimgbase.rect.bottom = /*22*/76;
	...
	duiimgbase.strImagePath = L"button2.bmp";
	pButton->SetBackImage(&duiimgbase,DUI_BUTTON_STATUS_HOT, &bResult);

	duiimgbase.strImagePath = L"button3.bmp";
	pButton->SetBackImage(&duiimgbase,DUI_BUTTON_STATUS_PRESS, &bResult);
